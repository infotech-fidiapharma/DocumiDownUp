...
<xsl:stylesheet xmlns:a="http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2" xmlns:c="http://www.fatturapa.gov.it/sdi/fatturapa/v1.0" xmlns:b="http://www.fatturapa.gov.it/sdi/fatturapa/v1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.1">
<xsl:output method="html"/>
<xsl:decimal-format grouping-separator="." decimal-separator="," name="euro"/>
...
<xsl:if test=" translate( TipoDato, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz' ) != 'aswrelstd' and translate( TipoDato, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz' ) != 'aswswhouse' and translate( TipoDato, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz' ) != 'aswtriga' ">
...
<xsl:when test=" translate( TipoDato, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz' ) = 'aswlottsca' ">
...
<xsl:if test=" translate( TipoDato, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz' ) != 'aswrelstd' and translate( TipoDato, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz' ) != 'aswswhouse' ">
...
<div class="page" id="fattura-elettronica">
...
<table class="tbHeader" id="tbHeader">
...
<xsl:if test="$TipoFattura/FatturaElettronicaHeader/CedentePrestatore">
...
<xsl:if test="$TipoFattura/FatturaElettronicaHeader/CessionarioCommittente">


<xsl:for-each select="$TipoFattura/FatturaElettronicaHeader/CessionarioCommittente/DatiAnagrafici">
...
<xsl:for-each select="$TipoFattura/FatturaElettronicaHeader/CessionarioCommittente/Sede">
...
<table class="tbFoglio" style="border-bottom-style:hidden">
...
<xsl:when test="$PecDestinatario"> Indicata PEC </xsl:when>
...
<th colspan="2"> Importo bollo </th>

<th colspan="3"> Sconto/Maggiorazione </th>

<th colspan="2"> Valuta </th>

<th colspan="3"> Totale documento </th>
...
<style type="text/css">
#fattura-elettronica { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin-left: auto; margin-right: auto; max-width: 1280px; min-width: 930px; padding: 0; } #fattura-elettronica div.page { } .tbHeader { width: 800px; border: 2px solid black; } tr td {vertical-align: top;} .tdHead { width: 50%; height: 91px; border: 1px solid black; } .tableHead { font-size:smaller; width: 100%; } .headBorder { 
<!--border: 2px solid black; width:100%; height: 210px; border-bottom-left-radius:30px; border-bottom-right-radius:30px; -->

} .headerLabel { color:#282828; font-weight:bold; } .headContent { margin-left:10px; margin-bottom:0px } .mt5 { margin-top:5px } tr.break { page-break-after: always; } .ulAllegati { margin-top:0px; } .separa { height:20px; } table.tbTitolo { width: 800px; table-layout: fixed; border-collapse: collapse; word-wrap:normal; 
<!--break-word;-->

} table.tbTitolo th { padding-left: 5px; padding-right: 5px; border: solid 1px #000000; border-bottom: none; background-color: LightCyan; font-size:x-small; } table.tbFoglio { width: 800px; table-layout: fixed; border-collapse: collapse; word-wrap:normal; 
<!--break-word;-->

} table.tbFoglio th { padding-left: 5px; padding-right: 5px; border: solid 1px #000000; background-color: LightGrey; 
<!-- text-transform: uppercase; -->

font-size:x-small; } table.tbFoglio tbody { border: solid 1px #000000; } table.tbFoglio th .perc { width:50px; } table.tbFoglio td { font-size:small; border-right: solid 1px #000000; border-bottom: none; border-left: solid 1px #000000; } table.tbFoglio tr { } .textRight { text-align:right; } .textCenter { text-align:center; } .textPerc { width:50px; } td.Ritenuta { width:50px; text-align:center; } th.title, .title td { width:48% } th.perc { width:50px; } th.perc2 { width:40px; } th.data { width:100px; } th.import { width:100px; } td.import { text-align:right; } th.import2 { width:80px; } td.import2 { text-align:right; } th.ximport { width:100px; } td.ximport { text-align:center; } th.ximport2 { width:80px; } td.ximport2 { text-align:center; } td.data { text-align:center; } .tx-xsmall { font-size:x-small; } .tx-small { font-size:small; } .import { text-align:right; } 
</style>
</head>
<body>
...
<xsl:when test="a:FatturaElettronica">
